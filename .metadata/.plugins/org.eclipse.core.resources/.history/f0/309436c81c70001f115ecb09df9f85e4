...
public class GroceriesController {
    ...
    @PostMapping("/search")
    public String searchGroceries(@RequestParam("query") String query, Model model) {
        List<Groceries> results = groceriesService.findByName(query);
        model.addAttribute("groceries", results);
        return "groceries";
    }
}
